...
import { validatePayload } from '../../../src/apis/workspace/validators/list.workspace';
import type { typePayload, typeResult, typeResultData, typeResultError } from '../../../src/apis/workspace/types/list.workspace';

describe('List Workspace - Validation Tests', () => {
  describe('Success Cases', () => {
    ...
    it('should validate with all optional fields', () => {
      const payload: typePayload = {
        // Add complete payload with all optional fields for list workspace
      };
  ...
  describe('Failure Cases', () => {
    it('should fail with invalid input', () => {
      const invalidPayload = {
        // Add invalid payload for list workspace
      } as typePayload;
